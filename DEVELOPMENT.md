...
```bash
git remote add encore encore://mt-lawyers-marketplace-zv2i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/mt-lawyers-marketplace-zv2i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/mt-lawyers-marketplace-zv2i/settings/integrations/github)
